    ...
    >
        <div className={`p-6 mt-5 bg-white bg-opacity-20 backdrop-blur-md shadow-lg rounded-lg border border-white border-opacity-30 ${roboto.className} w-full lg:w-[800px] `}>
            ...
            <ul className="list-none pl-0 md:pl-6 mb-6 text-white">               
                ...
                <img src="/logo_red.png" alt="Logo" className="w-4 mr-4 rounded-lg" style={{ filter: 'invert(1)' }} />
            ...
            <div className="bg-gray-800 bg-opacity-70 p-4 rounded-md">
                ...
                <p className="text-white mb-2"><strong>Enlace Conferencias:</strong> <a href="https://zoom.us/j/487385294" className="text-blue-300 hover:underline" target="_blank" rel="noopener noreferrer">https://zoom.us/j/487385294</a></p>
                <p className="text-white"><strong>Contraseña Conferencias:</strong> 69Tantra69</p>
            </div>
            </div>
