...
const AvailableResources: React.FC = () => {
  ...
  return (
    ...
    >
      <div className={`p-4 md:p-6 mt-5 bg-white bg-opacity-20 backdrop-blur-md shadow-lg rounded-lg border border-white border-opacity-30 ${roboto.className} w-full sm:w-[600px] md:w-[800px]`}>
