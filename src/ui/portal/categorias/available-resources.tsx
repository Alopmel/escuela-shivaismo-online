...
const AvailableResources: React.FC = () => {
  return (
    <motion.div
      ...
      className="flex flex-wrap justify-center items-start p-4 md:p-6" 
    >
      <div className={`p-4 md:p-6 mt-5 bg-white bg-opacity-20 backdrop-blur-md shadow-lg rounded-lg border border-white border-opacity-30 ${roboto.className} w-full sm:w-[600px] md:w-[80%] lg:w-[80%]`}>
        ...
        <ul className="list-none pl-0 mb-6">
          {[{
            ...
            route: 'Textos/Diccionario_sanscrit.pdf'
          },
          {
          ...
          },
          {
            ...
            <li key={index} className="mb-6 flex items-start w-full md:w-[80%]">
              <Image
                src="/logo_red.png"
                alt="Logo"
                width={25}
